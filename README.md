...
* **[Core Firmware & Algorithms](./src/firmware)** — Optimized sensor fusion and signal processing.
* **[AI Analytical Engine](./src/ai_bot)** — Python logic and LLM integration for data interpretation.
* **[Technical Documentation](./docs)** — Comprehensive research whitepapers and project reports.
* **[Hardware Architecture](./hardware)** — Circuit schematics and component specifications.
